...
from utils import default_openai_params
...
class Service(BaseModel):
    ...
    service_name: str = Field(max_length=50, default=openai_params["service_name"])
    api_key: str = Field(max_length=1000, default=openai_params["api_key"])
...
class Agent(BaseModel):
    ...
    model_name: str = Field(max_length=50, default=openai_params["model_name"])
...
class Topic(BaseModel):
    ...
    topic_name: str = Field(max_length=50, default=openai_params["topic_name"])
    topic_description: str = Field(max_length=10000, default=openai_params["topic_description"])
    tools: Optional[str] = None
    model_type: Optional[str] = Field(default=openai_params["model_type"])
    hyper_params: Optional[dict] = None
    created_at: int = Field(default_factory=get_current_epoch)
    updated_at: int = Field(default_factory=get_current_epoch)
